...
PROJECTS = [
    ...
    {"id": "3", "title": "STYLE 'N' SHOW EP2 STILL", "image": "https://res.cloudinary.com/dtnypuixy/image/upload/f_auto,q_auto/v1778262760/aesthetic-new.jpg", "is_video": False, "tags": ["Film"], "meta": "Visual Study"},
    ...
    {"id": "5", "title": "BLACK GIRL HAIR SHOP STILL", "image": "https://res.cloudinary.com/dtnypuixy/image/upload/f_auto,q_auto/shadow-form.JPG", "is_video": False, "tags": ["Editorial"], "meta": "Stills"},
...
# Specific Extra Videos for Archive
...
# Smart Archive Loader (Checks for work-1 through work-19)
for i in range(1, 20):
    PROJECTS.append({
